...
function AuthContent() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white px-4 pt-24 pb-16">
      <motion.div
      ...
      >
            ...
            <div className="px-8 pt-6 pb-8">
              ...
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  className="mb-6"
                >
                  <h1 className="text-[24px] font-normal tracking-[-0.03em] text-black">
                    {mode === 'wallet'
                      ? 'Connect Your Wallet'
                      : isSignUp
                        ? 'Create your account'
                  ...
                  <p className="text-black/40 text-sm mt-1.5">
                    {mode === 'wallet'
              ...
              {/* Error banner */}
              {errorParam && (
                <div className="flex items-start gap-3 p-4 rounded-2xl bg-red-50 border border-red-200 text-red-600 text-sm mb-5">
              ...
              {mode === 'choose' && (
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full flex items-center gap-4 p-4 rounded-2xl border border-[#E5E5E5] hover:border-black/30 hover:bg-[#F7F7F7] transition-all group"
                  >
                    <div className="w-10 h-10 rounded-xl border border-[#E5E5E5] bg-black flex items-center justify-center flex-shrink-0">
                      <Wallet className="w-5 h-5 text-white" />
                    </div>
                    <div className="text-left flex-1">
                      <div className="font-medium text-black text-[14px] group-hover:text-black transition-colors">
                        Connect Wallet
                      </div>
                  ...
                  <button
                    ...
                    disabled={isLoading}
                    className="w-full flex items-center gap-4 p-4 rounded-2xl border border-[#E5E5E5] hover:border-black/30 hover:bg-[#F7F7F7] transition-all group disabled:opacity-50"
                  >
                    <div className="w-10 h-10 rounded-xl border border-[#E5E5E5] bg-white flex items-center justify-center flex-shrink-0">
              ...
              {mode === 'wallet' && (
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full text-sm text-black/30 hover:text-black transition-colors"
                  >
                    Back to options
                  </button>
                </motion.div>
        ...
        {/* Footer */}
        <p className="text-center text-xs text-black/30 mt-5">
          By continuing you agree to our{' '}
          <Link href="#" className="underline underline-offset-2 hover:text-black transition-colors">Terms</Link> and{' '}
