...
interface DeploymentContextValue {
  ...
  startDeployment: (title: string) => void;
...
const INITIAL: DeploymentState = {
  ...
  campaignAddress: undefined, errorMsg: '',
};
...
export function DeploymentProvider({ children }: { children: ReactNode }) {
  ...
  const startDeployment = useCallback((title: string) =>
    setDeploy({ ...INITIAL, status: 'submitting', campaignTitle: title }), []);
